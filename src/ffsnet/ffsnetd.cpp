 ...
 * Desc: daemon process for FusionFS network transfer
 * Author: dzhao8@hawk.iit.edu
 * Known issues: the default port number is 9000; and is not changable
 *
 * Update history:
...
int main(int argc, char* argv[])
{
	...
	//DFZ: I know this is a bad practice...
...
void* transfile(void* usocket)
{
	...
	if (1 == is_recv) 
	{
		// so the format is to size+content
